...
Router.route('/company-projects', function () {
    ...
    {
        name: "companyInterestProjectDetail",
        data: function(){
        var id = Meteor.userId();
        return {
...
Router.route('/company-project-interest', function () {
...
Router.route('/try', function(){
    this.render('try')
})

Router.route('/my-company-projects', function(){
    this.render("myCompanyProjects");
},{
    name: "myCompanyProjects",
    layoutTemplate: "dashboardLayout"
});
